...
public class Beranda extends JFrame {
    ...
    private void initComponents() {
       ...
       // Membuat JLayeredPane untuk banner
        ...
        String[][] foods = {
                {"Sate", "200", "assets/sate.jpg"},
                {"Nasi Goreng", "100", "assets/nasi_goreng.jpg"},
                {"Bakso", "150", "assets/bakso.jpg"},
                {"Tumpeng", "150", "assets/tumpeng.jpg"}
        };
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Beranda().setVisible(true));
    }
}
